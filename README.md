...
```// filepath: c:\Users\Ranveer\Desktop\WRIS_WELL_Management\README.md

# GroundWater Table Statistics Tool (GWTST)

A small Windows GUI tool to process WRIS groundwater time-series Excel files, compute seasonal statistics, and perform Mann–Kendall (MK) trend analysis with Sen's slope.
